...
const Transaction = () => {
  ...
  return (
    <>
      ...
      <main className=" flex noto-sans-jp flex-1 md:flex-row flex-col items-center justify-center py-30 sm:px-6 lg:px-8">
        <div className="md:w-[50vw] w-[100vw] flex-col items-center justify-center space-y-6 lg:flex">
          <div className="w-full max-w-md rounded-xl bg-background-dark/50 p-6 shadow-sm md:mt-18">
              ...
              {transactions.map((item) => {
                return (
                  <div className="flex justify-between" key={item.category}>
                    <div
                      className="flex items-center w-[50%] justify-start gap-5 -space-y-1.5 p-3"
                    >
            ...
            >
              <defs>
                <linearGradient gradientTransform="rotate(45)" id="grad1">
                  <stop offset="0%" stopColor="rgba(32, 223, 108, 0.9)"></stop>
                  <stop offset="100%" stopColor="rgba(32, 223, 108, 0)"></stop>
                </linearGradient>
