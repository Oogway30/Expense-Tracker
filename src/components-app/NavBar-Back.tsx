...
const NavBar_Back = () => {
  ...
  return (
    <div className="fixed top-0 left-0 w-full  z-10">
      <div className="flex items-center justify-between min-h-max border-b-[1.5px] border-green-800 backdrop-blur-xs bg-white/1 sm:py-auto  px-5 xl:px-10 text-white">
