    ...
    <div >
      ...
      <table className="min-w-full mb-10 rounded-2xl text-sm text-left text-slate-500 dark:text-slate-400">
        <thead className="bg-primary/20 dark:bg-primary/30 text-xs text-slate-700 dark:text-slate-300 uppercase">
          <tr>
            <th className="px-6 py-3 text-gray-400 dark:text-slate-300" scope="col">Date</th>
            <th className="px-6 py-3 text-gray-400 dark:text-slate-300" scope="col">Category</th>
            <th className="px-6 py-3 text-gray-400 dark:text-slate-300" scope="col">Description</th>
            <th className="px-6 py-3 text-gray-400 dark:text-slate-300 text-right" scope="col">Amount</th>
          </tr>
        </thead>
        <tbody>
